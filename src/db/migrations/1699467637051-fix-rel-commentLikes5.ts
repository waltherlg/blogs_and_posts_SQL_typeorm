...
export class FixRelCommentLikes51699467637051 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "CommentLikes" DROP COLUMN "commentId"`);
        await queryRunner.query(`ALTER TABLE "CommentLikes" ADD "commentId" uuid NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "BlogBannedUsers" ALTER COLUMN "userId" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "CommentLikes" DROP CONSTRAINT "FK_83329f810e6a76c0eb6dc690d2a"`);
        await queryRunner.query(`ALTER TABLE "CommentLikes" DROP CONSTRAINT "FK_d9e6da41ef57e1b3ce506fb344f"`);
        await queryRunner.query(`ALTER TABLE "BlogBannedUsers" ALTER COLUMN "userId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "BlogBannedUsers" ADD CONSTRAINT "FK_19cb7e96476f86fd5d414aff8a2" FOREIGN KEY ("userId") REFERENCES "Users"("userId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Comments" DROP CONSTRAINT "PK_0d7d34e2ab9319b05fc35e114ab"`);
        await queryRunner.query(`ALTER TABLE "Comments" DROP COLUMN "commentId"`);
        ...
        await queryRunner.query(`ALTER TABLE "CommentLikes" DROP COLUMN "commentId"`);
        await queryRunner.query(`ALTER TABLE "CommentLikes" ADD "commentId" character varying NOT NULL`);
