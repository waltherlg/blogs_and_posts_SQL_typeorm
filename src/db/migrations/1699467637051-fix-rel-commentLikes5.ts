...
export class FixRelCommentLikes51699467637051 implements MigrationInterface {
  name = 'FixRelCommentLikes51699467637051';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Comments" DROP CONSTRAINT "PK_0d7d34e2ab9319b05fc35e114ab"`,
    );
    await queryRunner.query(`ALTER TABLE "Comments" DROP COLUMN "commentId"`);
    await queryRunner.query(
      `ALTER TABLE "Comments" ADD "commentId" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "Comments" ADD CONSTRAINT "PK_0d7d34e2ab9319b05fc35e114ab" PRIMARY KEY ("commentId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "BlogBannedUsers" DROP CONSTRAINT "FK_19cb7e96476f86fd5d414aff8a2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "BlogBannedUsers" ALTER COLUMN "userId" SET NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Comments" ADD CONSTRAINT "FK_0d7d34e2ab9319b05fc35e114ab" FOREIGN KEY ("commentId") REFERENCES "CommentLikes"("commentLikeId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Comments" DROP CONSTRAINT "FK_0d7d34e2ab9319b05fc35e114ab"`,
    );
    await queryRunner.query(
      `ALTER TABLE "CommentLikes" DROP CONSTRAINT "FK_83329f810e6a76c0eb6dc690d2a"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "BlogBannedUsers" ALTER COLUMN "userId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "BlogBannedUsers" ADD CONSTRAINT "FK_19cb7e96476f86fd5d414aff8a2" FOREIGN KEY ("userId") REFERENCES "Users"("userId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(`ALTER TABLE "Comments" DROP COLUMN "commentId"`);
    await queryRunner.query(
      `ALTER TABLE "Comments" ADD "commentId" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "Comments" ADD CONSTRAINT "PK_0d7d34e2ab9319b05fc35e114ab" PRIMARY KEY ("commentId")`,
    );
