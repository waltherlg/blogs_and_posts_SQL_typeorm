...
export class AddPlayerIdColumnsInGameTable1703246348056
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "QuizGames" ADD "player1Id" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "QuizGames" ADD "player2Id" uuid NOT NULL`,
    );
  }
