...
export class ChangeRelCommentLikes1699461431162 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "CommentLikes" ADD CONSTRAINT "FK_d9e6da41ef57e1b3ce506fb344f" FOREIGN KEY ("commentId") REFERENCES "CommentLikes"("commentLikeId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
