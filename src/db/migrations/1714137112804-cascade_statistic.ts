...
export class CascadeStatistic1714137112804 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "PlayerStatistic" ADD CONSTRAINT "FK_fd8b6f6beca5484b1f634334bd8" FOREIGN KEY ("userId") REFERENCES "Users"("userId") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
