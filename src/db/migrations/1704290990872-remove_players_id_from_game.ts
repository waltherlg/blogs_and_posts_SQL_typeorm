...
export class RemovePlayersIdFromGame1704290990872 implements MigrationInterface {
    name = 'RemovePlayersIdFromGame1704290990872'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "QuizGames" ALTER COLUMN "player1Id" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "QuizGames" ALTER COLUMN "player1Id" SET NOT NULL`);
    }
