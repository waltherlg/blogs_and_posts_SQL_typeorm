...
export class RemoveQuestionIdsFromGame1704600917404 implements MigrationInterface {
    name = 'RemoveQuestionIdsFromGame1704600917404'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "QuizGames" ALTER COLUMN "question1Id" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "QuizGames" ALTER COLUMN "question2Id" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "QuizGames" ALTER COLUMN "question3Id" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "QuizGames" ALTER COLUMN "question4Id" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "QuizGames" ALTER COLUMN "question5Id" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "QuizGames" ALTER COLUMN "question5Id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "QuizGames" ALTER COLUMN "question4Id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "QuizGames" ALTER COLUMN "question3Id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "QuizGames" ALTER COLUMN "question2Id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "QuizGames" ALTER COLUMN "question1Id" SET NOT NULL`);
    }
