...
import { PaginationOutputModel, RequestBlogsQueryModel } from '../../../models/types';
import { PostsRepository } from '../../../posts/posts.repository';
import { PostsQueryRepository } from '../../../posts/posts.query.repository';
import { PostTypeOutput } from '../../../posts/posts.types';

export class BloggerGetAllPostsByBlogIdCommand {
  constructor(public blogId: string, public userId: string, public mergedQueryParams: RequestBlogsQueryModel) {}
}
  ...
  implements ICommandHandler<BloggerGetAllPostsByBlogIdCommand>
{
  ...
  async execute(command: BloggerGetAllPostsByBlogIdCommand): Promise<ActionResult | PaginationOutputModel<PostTypeOutput>> {
